...
\item[(iv)] $L ( G ) \triangleq \set*{ z \in ( T^\prime )^\ast \mid S \Rightarrow_{P}^\ast z }$. $L ( G^\prime ) \triangleq \set*{ z \in ( T^\prime )^\ast \mid S^\prime \xRightarrow[\mathbf{rm}]{}_{P^\prime}^+ z \$ }$. $L ( G ) = L ( G^\prime )$.
...
\item[(xi)] $\mathrm{next} ( q , X ) := \mathrm{GOTO} ( q , X )$ for $q \in Q$ and $X \in V^\prime$.
...
\item[(xvi)] $L ( LRA ( G ) ) \triangleq \set*{ z \in ( T^\prime )^\ast \mid ( \varepsilon : q_0 \to q_0 , z \$ ) \vdash^+ ( S : q_0 \to q_f , \$ ) }$. $L ( G ) = L ( LRA ( G ) )$.
...
\begin{align}
\mathbf{LA} ( q , [ A \to \omega ] ) \triangleq \set*{ t \in T^\prime \mid S^\prime \xRightarrow[\mathbf{rm}]{}_{P^\prime}^+ \alpha A t z , \alpha \omega : q_0 \to q , \alpha \in ( V^\prime )^\ast , z \in ( T^\prime )^\ast } .
\end{align}
\end{theorem}
